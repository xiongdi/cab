...
<CardGrid stagger>
  <Card title="一个网关，多个 Agent" icon="rocket">
    Claude Code、Codex、OpenCode、Hermes、Kilo Code、OpenClaw、Pi——全部指向同一个 CAB 本地端点。
  </Card>
  <Card title="智能路由" icon="setting">
    选择策略——auto、balanced、intelligent 或 price——CAB 按能力、基准数据和 token 成本排序选模。
  </Card>
...
| **Balanced**    | 性价比最优——能力与 3:1 加权 token 成本 |
