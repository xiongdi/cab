...
<CardGrid stagger>
  <Card title="One gateway, many agents" icon="rocket">
    Claude Code, Codex, OpenCode, Hermes, Kilo Code, OpenClaw, and Pi — all point at the same local
    CAB endpoint.
  </Card>
  <Card title="Smart routing" icon="setting">
    Pick a strategy — auto, balanced, intelligent, or price — and CAB ranks models by capability,
