...
本文说明如何从 [GitHub Releases](https://github.com/xiongdi/cab/releases) 下载并安装桌面版。若需从源码构建，请参阅 [README](../README.md) 与 [中文 README](README.zh-CN.md)。
...
将下文中的 `VERSION` 替换为发布号（不含 `v` 前缀，例如 `0.1.2`）。
