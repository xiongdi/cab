...
use crate::ws_responses::handle_ws_socket;
...
///
/// Codex uses flat `response.create` frames and expects SSE-equivalent
/// `response.*` events as JSON text frames on a long-lived socket. See
/// [`crate::ws_responses`].
