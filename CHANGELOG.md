...
- **Prompt-cache miss diagnostics.** Per-session prefix-shape tracking emits a gateway log explaining *why* a cache likely went cold (system prompt vs. tool schemas changed) between turns.
